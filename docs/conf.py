...
# -*- coding: utf-8 -*-
#
# simplecrypto documentation build configuration file, created by
...
copyright = '2013, Lucas Boppre Niehues'
...
htmlhelp_basename = 'simplecryptodoc'
...
latex_documents = [
  ('index', 'simplecrypto.tex', 'simplecrypto Documentation',
   'Lucas Boppre Niehues', 'manual'),
]
...
man_pages = [
    ('index', 'simplecrypto', 'simplecrypto Documentation',
     ['Lucas Boppre Niehues'], 1)
]
...
texinfo_documents = [
  ('index', 'simplecrypto', 'simplecrypto Documentation',
   'Lucas Boppre Niehues', 'simplecrypto', 'One line description of project.',
   'Miscellaneous'),
]
